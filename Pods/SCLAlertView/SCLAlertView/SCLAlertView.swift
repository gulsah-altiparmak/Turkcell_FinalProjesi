...
//        let titleOffset : CGFloat = appearance.showCircularIcon ? 0.0 : -12.0
    ...
    @discardableResult
    open func showInfo(_ title: String, subTitle: String, closeButtonTitle:String?="Tamam", timeout:SCLTimeoutConfiguration?=nil, colorStyle: UInt=SCLAlertViewStyle.info.defaultColorInt, colorTextButton: UInt=0xFFFFFF, circleIconImage: UIImage? = nil, animationStyle: SCLAnimationStyle = .topToBottom) -> SCLAlertViewResponder {
